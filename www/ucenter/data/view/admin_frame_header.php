...
<div class="mainhd">
	...
	<div class="uinfo">
		<p>Chào bạn , <em><?=$username?></em> [ <a href="admin.php?m=user&a=logout" target="_top">Thoát</a> ]</p>
		<? if($admincp) { ?>
			<p id="others"><a href="#" class="othersoff" onclick="showmenu(this);">Quản lý khác</a></p>
