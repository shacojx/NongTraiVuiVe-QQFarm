...
define('UC_DBPW', 'vertrigo'); // UCenter 数据库密码
define('UC_DBNAME', 'home'); // UCenter 数据库名称
define('UC_DBCHARSET', 'utf8'); // UCenter 数据库字符集
define('UC_DBTABLEPRE', '`home`.uc_'); // UCenter 数据库表前缀
define('UC_DBCONNECT', '0'); // UCenter 数据库持久连接 0=关闭, 1=打开
define('UC_KEY', 'd3u3I0ldAac6T2v7P7GbidC6AbM1gbB7g2D80a44ec2dF9t7z9IdSca9hfi8w4p1'); // 与 UCenter 的通信密钥, 要与 UCenter 保持一致
