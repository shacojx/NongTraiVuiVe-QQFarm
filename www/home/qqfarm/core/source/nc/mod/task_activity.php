...
if($actid==0){//Christmas gift Christmas cards Q [2002] 2, Santa Claus [2001] Card 1
	if($op==0){
		if($fruit['2001'] < 1 || $fruit['2002'] < 2 ){
			die('{"errorContent":"Bạn chưa đủ điều kiện để nhận thưởng","errorType":"logic","limit":[{"id":2001,"num":'.(1-$fruit['2001']).'},{"id":2002,"num":'.(2-$fruit['2002']).'}]}');
		} else {
			echo'{"code":1}';
		}
	} elseif($op==1){
		if( $fruit['2001']>0 && $fruit['2002']>1 ){
			...
			die('{"code":50,"errorContent":"Bạn chưa đủ điều kiện để nhận thưởng"}');
		}
	}
	...
	if($op==0){
		if($fruit['2001'] < 1 || $fruit['2005'] < 2 ){
			die('{"errorContent":"Bạn chưa đủ điều kiện để nhận thưởng","errorType":"logic","limit":[{"id":2001,"num":'.(1-$fruit['2001']).'},{"id":2005,"num":'.(2-$fruit['2005']).'}]}');
		} else {
			echo'{"code":1}';
		}
	} elseif($op==1){
	...
	if($op==0){
		if( $fruit['2001']<10 || $fruit['2002']<30 || $fruit['2005']<30){
			die('{"errorContent":"Bạn chưa đủ điều kiện để nhận thưởng","errorType":"logic","limit":[{"id":2002,"num":'.(30-$fruit['2002']).'},{"id":2005,"num":'.(30-$fruit['2005']).'},{"id":2001,"num":'.(10-$fruit['2001']).'}]}');
	...
	if($op==0){
		if($fruit['2003'] < 1 || $fruit['2004'] < 2 ){
			die('{"errorContent":"Bạn chưa đủ điều kiện để nhận thưởng","errorType":"logic","limit":[{"id":2003,"num":'.(1-$fruit['2003']).'},{"id":2004,"num":'.(2-$fruit['2004']).'}]}');
		} else {
			echo'{"code":1}';
		}
	} elseif($op==1){
	...
	if($op==0){
		if( $fruit['2003']<10 || $fruit['2004']<30 ){
			die('{"errorContent":"Bạn chưa đủ điều kiện để nhận thưởng","errorType":"logic","limit":[{"id":2004,"num":'.(30-$fruit['2004']).'},{"id":2003,"num":'.(10-$fruit['2003']).'}]}');
