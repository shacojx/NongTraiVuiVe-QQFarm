...
echo '{"cId":' . $cid . ',"code":1,"direction":"Đã bán <font color=\"#0099FF\"> <b>' . $number . '<\/b> <\/font>' . $cropstype[$cid]['cName'] . ' với giá <font color=\"#FF6600\"> <b>' . $price * $number . '<\/b> Xu<\/font>","money":' . $price * $number . '}';
