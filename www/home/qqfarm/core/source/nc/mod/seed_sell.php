...
if($cid){
	if($package[$cid] < $number) {
		die('{"cId":'.$cid.',"code":0,"direction":"Bạn không có vật phẩm này."}');
	} else {
	...
	echo'{"cId":'.$cid.',"code":1,"direction":"Đã bán <font color=\"#0099FF\"> <b>'.$number.'</b> </font>hạt giống '.$cropstype[$cid]["cName"].' với giá <font color=\"#FF6600\"> <b>'.$money.'</b> Xu</font>","money":'.$money.'}';	
