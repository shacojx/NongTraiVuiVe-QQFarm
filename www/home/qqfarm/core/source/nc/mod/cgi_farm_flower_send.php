...
if($uIdx == $toId) die('{"code":0,"direction":"Không thể tặng hoa cho chính mình được!"}');
...
echo '{"code":1,"direction":"Đã gửi tặng theo yêu cầu! Chắc hẳn người ấy sẽ rất vui khi nhận được món quà này"}';
