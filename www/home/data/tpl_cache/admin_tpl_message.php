<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('admin/tpl/message|admin/tpl/header|admin/tpl/footer|template/default/header|template/default/footer', '1315016232', 'admin/tpl/message');?><meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
...
&nbsp; <?php if($url_forward) { ?><a href="<?=$url_forward?>">OK</a> &nbsp; <?php } ?><a href="javascript:history.back(-1)">Back to Previous Page</a> &nbsp; <a href="admincp.php">Management Home</a>
</div>
