<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/showmessage|template/default/header|template/default/footer', '1315016457', 'template/default/showmessage');?><?php $_TPL['nosidebar']=1; ?>
...
<p class="op">
<?php if($url_forward) { ?>
<a href="<?=$url_forward?>">Click vào đây nếu không tự chuyển...</a>
<?php } else { ?>
