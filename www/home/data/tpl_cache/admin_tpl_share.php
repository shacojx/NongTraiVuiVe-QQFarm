<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('admin/tpl/share|admin/tpl/header|admin/tpl/side|admin/tpl/footer|template/default/header|template/default/footer', '1315016499', 'admin/tpl/share');?>﻿<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
...
<td>
<p><a href="admincp.php?ac=share&uid=<?=$value['uid']?>"><?=$value['username']?></a> <?=$value['title_template']?> &nbsp;<?php echo sgmdate('Y-m-d H:i', $value[dateline]); ?><?php if($value['hot']) { ?><span style="color:red;">Hot(<?=$value['hot']?>)</span><?php } ?></p>
<?=$value['body_template']?>
<br>
