<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('admin/tpl/thread|admin/tpl/header|admin/tpl/side|admin/tpl/footer|template/default/header|template/default/footer', '1315016503', 'admin/tpl/thread');?><meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
...
<option value="1"<?php if($_GET['digest']==1) { ?> selected<?php } ?>>Essence quote</option>
</select>
</td></tr>
...
<?php if($allowmanage) { ?><th width="80">Author</th><?php } ?>
<th width="80">Time</th>
</tr>
<?php if(is_array($list)) { foreach($list as $value) { ?>
<tr>
...
<?php if($value['digest']) { ?>[<a href="<?=$mpurl?>&digest=<?=$value['digest']?>">Fine</a>]<?php } ?>
