<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('admin/tpl/post|admin/tpl/header|admin/tpl/side|admin/tpl/footer|template/default/header|template/default/footer', '1315016502', 'admin/tpl/post');?><meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
...
<option value="1"<?php if($_GET['isthread']==1) { ?> selected<?php } ?>>Theme Posts</option>
</select>
</td></tr>
...
<td>
<?php if($value['isthread']) { ?>[Theme]<?php } else { ?>[Replies]<?php } ?> <a href="space.php?uid=<?=$space['uid']?>&do=thread&id=<?=$value['tid']?>" target="_blank"><?=$threads[$value['tid']]?></a>
